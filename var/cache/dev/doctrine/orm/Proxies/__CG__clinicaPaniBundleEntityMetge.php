...
namespace Proxies\__CG__\clinicaPaniBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Metge extends \clinicaPaniBundle\Entity\Metge implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Metge $proxy) {
    ...
    public function setEspecialitat($especialitat)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEspecialitat', [$especialitat]);

        return parent::setEspecialitat($especialitat);
    }
